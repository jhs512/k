...
tags: ["수파베이스", "스키마", "환경분리", "데이터베이스", "다중환경"]
edges: [
  {"target": "연락처-장희성", "type": "authored_by", "weight": 1.0, "note": "장희성의 수파베이스 스키마 환경 분리 전략"},
  {"target": "결정-수파베이스-클라우드-우선", "type": "preceded_by", "weight": 0.9, "note": "클라우드 선호 결정 이후 자연스럽게 따라오는 스키마 분리 전략"},
  {"target": "패턴-수파베이스-members-테이블", "type": "related_to", "weight": 0.8, "note": "각 스키마에서 members 테이블 패턴이 동일하게 적용된다"}
]
related: ["[[수파베이스 클라우드 환경 선호]]", "결정-수파베이스-클라우드-우선"]
source_url: "Empty"
---
